...
* [Polycopié [pdf]](./files/teaching/poly-auto-osae.pdf)
* Systèmes linéaires invariant analogiques
* Asservissement, stabilités, performances
* Systèmes et automatique numérique

## L3 E3A — Signaux et systèmes linéaires

Cours de traitement du signal du L3 Électronique, Énergie Électrique, Automatique - Univ. Paris-Saclay

* [Polycopié [pdf]](./files/teaching/poly-ssl.pdf)
* [Sujet de TP [pdf]](./files/teaching/ssl-tp.pdf)
* Signaux déterministes
* Convolution et transformations de Fourier
* Numérisation et échantillonnage
* Systèmes linéaires invariants, filtrage

## M1 Programmation et Données Numériques

## M1 MFL — Traitement du signal (2015 - 2023)

Cours de traitement du signal du M1 de Physique et Application et du M1 de Mécanique - Univ. Paris-Saclay

* [Polycopié [pdf]](./files/teaching/poly-ts-phys.pdf)
* Base des probabilités et de l'estimation pour les signaux aléatoires
